...
public class Game_Two_Players extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game__two__players);


        TextView ourText = (TextView) findViewById(R.id.textView2);
        //TextView ourText1 = (TextView) findViewById(R.id.textView3);
        TextView ourText2 = (TextView) findViewById(R.id.textView4);
        Typeface tf = Typeface.createFromAsset(getAssets(), "homespun.ttf");
        ourText.setTypeface(tf);
        //ourText1.setTypeface(tf);
        ...
        final ImageView racquet_2 = (ImageView) findViewById(R.id.imageView3);
                ...
                public void onTick(long millisUntilFinished) {
                    if(moving_ball) // proti desni
                    {
                        if(ball.getX() < (racquet_2.getX() - 19)) {           //pozicija žoge manjša od maxX
                            ...
                            if((ball.getY() < racquet_2.getY() + 166) && (ball.getY() > racquet_2.getY() - 10 ) ) {
                                MediaPlayer pong = MediaPlayer.create(Game_Two_Players.this, R.drawable.pong);
                                pong.start();
                                yMove = (ball.getY() - racquet_2.getY() + 1)/(166) - 0.5f; // 0 naravnost
                                moving_ball = false;
                                playing = true;
                                direction = 1;
                                //speed = speed / 2;
                    ...
                    if(!moving_ball) // proti levi
                    {
                        if(ball.getX() > (racquet.getX() + 19)) {           //pozicija žoge manjša od maxX
                            ...
                            else
                            {
                               ...
                               {
                                   String fontPath = "homespun.ttf";
                                   TextView ourText3 = (TextView) findViewById(R.id.textView4);
                                   Typeface tf = Typeface.createFromAsset(getAssets(), fontPath);
